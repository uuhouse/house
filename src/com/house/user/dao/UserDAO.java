...
public class UserDAO {
	...
	public String getPassword(String username) {
		String sql = "select password from user where user.username = `" + username +"`";
	...
	public String getPower(String username) {
		String sql = "select power from user where user.username = `" + username + "`";
		Query query = getSession().createQuery(sql);
		if(query.list().size() != 0) {
			return (String) query.list().get(0);
		}else {
	...
	public String getName(String username) {
		String sql = "select name from user where user.username = `" + username + "`";
		Query query = getSession().createQuery(sql);
		if(query.list().size() != 0) {
			return (String) query.list().get(0);
		}else {
